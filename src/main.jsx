...
function Artwork({project,eager=false}){
  ...
  if(p.sourceName)return <div className="artwork reference-mobile-art"><div className="reference-phone"><Image item={p.cover[0]} thumb eager={eager}/></div><span className="reference-kicker">MOBILE REFERENCE</span></div>;
